...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--nef_S3', type=int, default=64, help='# of encoder filters in the first conv layer')
        parser.add_argument('--ngf_S3', type=int, default=64, help='# of gen filters in the last conv layer')
        parser.add_argument('--ndf_S3', type=int, default=64, help='# of discrim filters in the first conv layer')
        parser.add_argument('--nef_S12', type=int, default=64, help='# of encoder filters in the first conv layer')
        parser.add_argument('--ngf_S12', type=int, default=64, help='# of gen filters in the last conv layer')
        parser.add_argument('--ndf_S12', type=int, default=64, help='# of discrim filters in the first conv layer')    
        ...
        # new added by Xiaohu Lu
        parser.add_argument('--pin_memory', type=bool, default=True, help='use pinned (page-locked) memory. when using CUDA, set to True')
        parser.add_argument('--is_train', type=bool, default=True, help='when train, set to True')
        parser.add_argument('--sate_gsd', type=float, default=0.5, help='ground sample distance of satellite image, 0.5m for WorldView2')
        parser.add_argument('--pano_size', default=[256,512], help='size of projected panorama')
        parser.add_argument('--norm_G_D', type=str, default='batch', help='instance normalization or batch normalization')
        parser.add_argument('--no_dropout', type=bool, default=True, help='no dropout for the generator')
        parser.add_argument('--no_lsgan', type=bool, default=True, help='do *not* use least square GAN, if false, use vanilla GAN')        
        parser.add_argument('--resultroot', type=str, help='path to result')
